...
g++ \
    ...
    -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0     -lgmodule-2.0 -lgthread-2.0 -lglib-2.0 -lgthread-2.0 -lglib-2.0 -ldl -lm -lpthread -lrt \
    -pthread \
    -L../../boinc/api \
    -L../../boinc/lib \
    -lboinc_api \
