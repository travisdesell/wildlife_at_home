...
int main(int argc, char **argv) {
    ...
    desc.add_options()
        ...
        ("top_left,tl", po::value<std::vector<float> >()->multitoken(), "Top-left box corner");
        ("bottom_right,br", po::value<std::vector<float> >()->multitoken(), "Bottom-right box corner");
