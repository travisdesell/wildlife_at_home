...
$carousel_info['items'][] = array(
    'image' => './images/thumbnail_sharptailed_grouse_resized.png',
...
$carousel_info['items'][] = array(
    'image' => './images/HenCapture2_small.png',
...
$carousel_info['items'][] = array(
    'image' => './images/RadioTracking1_small.png',
...
$carousel_info['items'][] = array(
    'image' => './images/grouse_nest.png',
    'text' => "<p>A sharp-tailed grouse nest.</p>");

$carousel_info['items'][] = array(
    'image' => './images/hen_on_nest.png',
...
$carousel_info['items'][] = array(
    'image' => './images/hatch.png',
    'text' => "<p>Sharp-tailed grouse chicks hatching.</p>");

$carousel_info['items'][] = array(
    'image' => './images/hawk2_resized.png',
...
$carousel_info['items'][] = array(
    'image' => './images/plover_in_flight.png',
...
$carousel_info['items'][] = array(
    'image' => './images/tern_nest_exchange.png',
...
$carousel_info['items'][] = array(
    'image' => './images/tern_feeding_tern.png',
...
echo "
            <div class='btn-group btn-group-justified' style='margin-top:20px;'>
                ...
                <a class='btn btn-primary' role='button' href='./image_selector.php'><h4>Review Wildlife Images</h4></a>
            </div>
