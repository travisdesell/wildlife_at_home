...
if ($species_id == 1) {
    echo "          <ul class='dropdown-menu' id='event-dropdown-$video_id'>
                        ...
                        <li class='nav-header'>Parent Behavior</li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - not in frame' video_id='$video_id' id='not-in-frame-dropdown'>Not In Frame</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - in frame' video_id='$video_id' id='in-frame-dropdown'>In Frame</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - on nest' video_id='$video_id' id='on-nest-dropdown'>On Nest</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - walking'  video_id='$video_id' id='walking-dropdown'>Walking</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - flying'  video_id='$video_id' id='flying-dropdown'>Flying</a></li>
                        ...
                        <li><a href='javascript:;' class='event-dropdown' event_id='camera interaction - attack' video_id='$video_id' id='camera-attack-dropdown'>Attack</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='camera interaction - inspection' video_id='$video_id' id='camera-inspection-dropdown'>Physical Inspection</a></li>
                        <li><a href='javascript:;' class='event-dropdown' event_id='camera interaction - observation' video_id='$video_id' id='camera-observation-dropdown'>Observation</a></li>
                    </ul>";

} else if ($species_id == 2) {
    echo "          <ul class='dropdown-menu' id='event-dropdown-$video_id' style='width:400px;'>
                        <li class='column-menu span6 firstcolumn'>
                            <ul style='list-style-type: none; margin-left:10px;'>
                                ...
                                <li class='nav-header'>Territorial</li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - chase'  video_id='$video_id' id='chase-dropdown'>Chase</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - crouch'  video_id='$video_id' id='crouch-dropdown'>Crouch</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - submissive'  video_id='$video_id' id='submissive-dropdown'>Submissive</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - predator' video_id='$video_id' id='predator-dropdown'>Predator</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - other animal' video_id='$video_id' id='other-animal-dropdown'>Other Animal</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - nest defense' video_id='$video_id' id='nest-defense-dropdown'>Nest Defense</a></li>
                            </ul>
                        ...
                        <li class='column-menu span6'>
                            <ul style='list-style-type: none; margin-right:10px;'>
                                ...
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - brood'  video_id='$video_id' id='brood-dropdown'>Brood</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - cool shade'  video_id='$video_id' id='cool-shade-dropdown'>Cool Shade</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - nest exchange'  video_id='$video_id' id='nest-exchange-dropdown'>Nest Exchange</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - eggshell removal'  video_id='$video_id' id='eggshell-removal-dropdown'>Eggshell Removal</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - fail parental feed'  video_id='$video_id' id='unsuccessful-feed-preen-dropdown'>Unsuccessful Feeding</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - success parental feed'  video_id='$video_id' id='successful-feed-dropdown'>Successful Feeding</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - unknown parental feed'  video_id='$video_id' id='unknown-feed-dropdown'>Unknown Feeding</a></li>
                                <li class='nav-header'>Chick Behavior</li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='nest success' video_id='$video_id' id='nest-success-dropdown'>Nest Success</a></li>
                                ...
                                <li><a href='javascript:;' class='event-dropdown' event_id='chick behavior - walking'  video_id='$video_id' id='chick-walking-dropdown'>Walking</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='chick behavior - foraging'  video_id='$video_id' id='chick-foraging-dropdown'>Foraging</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='chick behavior - submissive'  video_id='$video_id' id='chick-submissive-dropdown'>Submissive</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='chick behavior - running'  video_id='$video_id' id='chick-running-dropdown'>Running</a></li>
                                <li class='nav-header'>Miscellaneous</li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='unspecified' video_id='$video_id' id='any-event-dropdown'>Unspecified</a></li>
    ...
    echo "          <ul class='dropdown-menu' id='event-dropdown-$video_id' style='width:350px;'>
                        <li class='column-menu span6 firstcolumn'>
                            <ul style='list-style-type: none; margin-left:10px;'>
                                ...
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent behavior - flying'  video_id='$video_id' id='flying-dropdown'>Flying</a></li>
                                <li class='nav-header'>Parent Care</li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - brood'  video_id='$video_id' id='parent-brood-dropdown'>Brood</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - cool shade'  video_id='$video_id' id='parent-cool-dropdown'>Cool Shade</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - nest exchange'  video_id='$video_id' id='parent-exchange-dropdown'>Nest Exchange</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='parent care - eggshell removal'  video_id='$video_id' id='parent-eggshell-dropdown'>Eggshell Removal</a></li>
                                <li class='nav-header'>Territorial</li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - chase'  video_id='$video_id' id='chase-dropdown'>Chase</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - crouch'  video_id='$video_id' id='crouch-dropdown'>Crouch</a></li>
                                <li><a href='javascript:;' class='event-dropdown' event_id='territorial - submissive'  video_id='$video_id' id='submissive-dropdown'>Submissive</a></li>
