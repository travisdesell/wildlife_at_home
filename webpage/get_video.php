...
$query = "SELECT species_id, watermarked_filename, animal_id, processing_status, start_time FROM video_2 WHERE id = $video_id";
...
if ($row['processing_status'] == 'UNWATERMARKED') {
    ...
    echo get_expert_video_row($species_id, $video_id, $video_file, $animal_id, $start_time, $user);
}
