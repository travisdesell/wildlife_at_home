...
$(document).ready(function () {
    ...
    var belden_content = "<p>" + grouse_belden_validated + " videos watched</p>" +
                           "<p>" + grouse_belden_processed + " videos available</p>" +
    ...
    var blaisdell_content = "<p>" + grouse_blaisdell_validated + " videos watched</p>" +
                           "<p>" + grouse_blaisdell_processed + " videos available</p>" +
    ...
    var lostwood_content = "<p>" + grouse_lostwood_validated + " videos watched</p>" +
                           "<p>" + grouse_lostwood_processed + " videos available</p>" +
    ...
    var least_tern_content = "<p>" + least_tern_validated + " videos watched</p>" +
                           "<p>" + least_tern_processed + " videos available</p>" +
                           "<p>" + least_tern_total + " videos total</p>";

    $('#least_tern_progress').popover({ placement : 'bottom', html : true,  content : least_tern_content, title : 'Progress'});


    var piping_plover_content = "<p>" + piping_plover_validated + " videos watched</p>" +
                           "<p>" + piping_plover_processed + " videos available</p>" +
                           "<p>" + piping_plover_total + " videos total</p>";
