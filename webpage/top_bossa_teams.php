...
function get_top_teams($offset, $sort_by, $type){
    ...
    } else if ($sort_by == "total_credit") {
        $sort_order = "total_credit desc";
    } else if ($sort_by == "expavg_credit") {
...
page_head(tra("Wildlife@Home Top %1 teams", $type_name), null, null, "", null, $active_items);
